...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO fanroom (`In`, `Out`, Adult, Child) VALUES (%s, %s, %s, %s)",
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            ...
            <div class="block-3 d-md-flex">
              <div class="image" style="background-image: url('../images/7379.jpg'); "></div>
              <div class="text">

                <h2 class="heading">Fan Room</h2>
                <div class="price"><sup>฿</sup><span class="number">400</span><sub>/per night</sub></div>
                <ul class="specs mb-5">
